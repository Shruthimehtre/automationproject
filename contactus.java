...
public class contactus extends browser
{
	@Test(priority = 3)
	public void contactUs() throws Throwable
	{
		...
		driver.findElement(By.xpath("//*[@placeholder='Username']")).sendKeys("shruthi");
		driver.findElement(By.cssSelector("input[placeholder='Email']")).sendKeys("shruthi@gmail.com");
		driver.findElement(By.cssSelector("input[type='tel']")).sendKeys("89784774523");
		driver.findElement(By.xpath("//*[@name='message']")).sendKeys("s h r thi");
