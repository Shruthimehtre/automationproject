...
public class order extends homwpage
{
	@Test(priority = 3)
	public void Order() throws InterruptedException, AWTException{
		...
		driver.findElement(By.id("inputFirstName")).sendKeys("shruthi");
		driver.findElement(By.xpath("(//*[@id='inputFirstName'])[2]")).sendKeys("mehtre");
		driver.findElement(By.id("inputEmail")).sendKeys("shruthi@gmail.com");
		driver.findElement(By.id("inputPassword")).sendKeys("$@i123");
		driver.findElement(By.id("flexRadioDefault1")).click();
		driver.findElement(By.xpath("//*[@placeholder='00000000000']")).sendKeys("7856846011");
		driver.findElement(By.id(" address1")).sendKeys("1/a");
		driver.findElement(By.id("address2")).sendKeys("1-56, bangalore");
		...
		driver.findElement(By.id("inputZip")).sendKeys("5900065");
